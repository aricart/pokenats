...
BaseService.prototype.badRequest = function(data) {
  ...
  var subject = poke.makeSubject(poke.POKENATS_MONITOR, this.opts.serviceType, this.opts.client, poke.LOG, poke.INVALID);
...
BaseService.prototype.logError = function() {
  var args = [];
  var subj = poke.makeSubject(poke.POKENATS_MONITOR,
