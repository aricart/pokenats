...
ControlService.prototype.handleConnect = function(nc) {
  ...
  // subject name in the heartbeat has the servicename.clientname
  this.monintoringSub = nc.subscribe(poke.POKENATS_MONITORING + '.>', queueGroup, this.handleMonitoring.bind(this));
  this.loginfo('[S] ' + poke.POKENATS_MONITORING + '.>[' + queueGroup +']');
